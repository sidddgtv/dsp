						...
						<h2 class="text-center mb-4">Nanny questionnaire</h2>
			                ...
			                <div class="tab">
			                    <p>
			                    	...
			                    	<input type="text" onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;" placeholder="Cell phone" oninput="this.className = ''" name="cellphone" class="form-control">
			                    </p>
			                </div>
			                <div class="tab">      
								<p>
			                ...
			                <div class="tab">
			                    <p>
			                    	...
			                    	<input type="text" onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;" placeholder=" " oninput="this.className = ''" name="professional" class="form-control">
			                    </p>
			                </div>
			                <div class="tab">
			                <p>
			                ...
			                <div class="tab">
			                	<p>
			                        ...
			                        <select name="childcare" class="form-select">
							...
							<div class="tab" style="display: block;">
									...
									<div class="input-group">
										...
										<input type="text" oninput="this.className = ''" class="mb-0 form-control" placeholder="Instagram">
							...
							<div class="tab">
								<p>
									...
									<input type="email" oninput="this.className = ''" name="pastemail" class="form-control">
								</p>
							</div>
							<div class="tab">
								<p>
									<label>Past Employment Phone Number</label>
									<input type="text" onkeypress="if ( isNaN( String.fromCharCode(event.keyCode) )) return false;" oninput="this.className = ''" name="pastphone" class="form-control">
								</p>
							</div>
							<div class="tab">
								<p>
