...
$(document).ready(function() {
	...
	$(document).delegate('.popup-modal', 'click', function(e) {
		e.preventDefault();
		...
		$.ajax({
			...
			success: function(data) {
				html  = '<div id="panel-modal" class="modal fade">';
				html += '  <div class="modal-dialog">';
				html += '    <div class="modal-content p-0 b-0">';
				html += '		<div class="panel panel-color panel-primary">';
				html += '      	<div class="panel-heading">';
				html += '        		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>';
				html += '        		<h3 class="panel-title">' + $(element).data('title') + '</h4>';
				html += '      	</div>';
				html += '      	<div class="panel-body">' + data + '</div>';
				html += '    	</div>';
				html += '    </div>';
				html += '  </div>';
				html += '</div>';
