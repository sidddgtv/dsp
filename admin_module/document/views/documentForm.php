...
<div class="pull-right">
    <button type="submit" form="form-page" data-toggle="tooltip" title="Add Document" class="btn btn-primary btn-sm"><i class="fa fa-save"></i></button>
...
<div class="row mt-4 required">
    <label for="title" class="col-2 control-label">Document Name</label>
    <div class="col-10">
...
<div class="row mt-4">
    <label for="title" class="col-2 control-label">Document Description</label>
    <div class="col-10">
         <textarea name="doc_description" rows="5" cols="10" class="ckeditor_textarea form-control" id = "doc_description"><?=$doc_description?></textarea>     
    </div>
</div>
