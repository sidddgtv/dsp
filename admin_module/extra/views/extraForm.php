...
<div class="pull-right">
    <button type="submit" form="form-page" data-toggle="tooltip" title="Add Extra" class="btn btn-primary btn-sm"><i class="fa fa-save"></i></button>
...
<div class="row mt-4 required">
    <label for="title" class="col-2 control-label">Resource Name</label>
    <div class="col-10">
